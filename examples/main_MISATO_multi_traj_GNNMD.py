...
from models.GNNMD_Binding import GNNMD
...
def train(loader):
    ...
    for batch_idx, batch in enumerate(L):
        ...
        for traj_idx in range(start_traj_idx, end_traj_idx):
            ...
            pos_delta = binding_model(pos_input, condition, t=t_tensor)
            pos_pred = pos_input + pos_delta
            
            loss = criterion(pos_pred, pos_target)
...
if __name__ == "__main__":
    ...
    binding_model = GNNMD(args).to(device)
